...
const teaBuildinContext: TeaBuildinContextDeclare = {
    ...
    types: [
        ...
        },
        {
            name: "-bitmap-return-",
            field: [
                { name: "destx", type: "Double", description: "Bitmap在屏幕上的X坐标" },
                { name: "desty", type: "Double", description: "Bitmap在屏幕上的Y坐标" },
                { name: "scalex", type: "Double", description: "X轴缩放比例" },
                { name: "scaley", type: "Double", description: "Y轴缩放比例" },
                { name: "rotating", type: "Double", description: "Bitmap的旋转角度" },
                { name: "hide", type: "Double", description: "是否隐藏" },
                { name: "zpos", type: "Double", description: "z-index 坐标" },
                { name: "color", type: "Double", description: "颜色参数, 建议用forecolor" },
                { name: "blendMode", type: "Double", description: "混合模式" },
                { name: "attscreen", type: "Double", description: "是否为固定屏幕坐标" },
                { name: "scrx", type: "Double", description: "裁剪源文件的开始点X坐标" },
                { name: "scry", type: "Double", description: "裁剪源文件的开始点Y坐标" },
                { name: "scrwidth", type: "Byte", description: "裁剪源文件的宽度" },
                { name: "scrheight", type: "Byte", description: "裁剪源文件的高度" },
                { name: "rotatx", type: "Double", description: "缩放或旋转中心点X坐标" },
                { name: "rotaty", type: "Double", description: "缩放或旋转中心点Y坐标" },
                { name: "scrid", type: "Double", description: "原图NPC ID" },
            ]
        },
        {
            name: "-block-return-",
        ...
        },
        {
            ...
            field: [
                ...
                { name: "id", type: "Double", description: "玩家的ID" },
                ...
                { name: "ynpcid", type: "Double", description: "当玩家操纵耀西时被耀西吞下去的NPC" },
                { name: "sjumping", type: "Double", description: "玩家是否在旋转跳跃状态" },
                { name: "grabbing", type: "Double", description: "返回玩家所拿取的NPC的PermID" },
                ...
                { name: "pulling", type: "Double", description: "玩家是否处在挖掘或抓取NPC的状态" },
                { name: "sliding", type: "Double", description: "玩家是否在滑行" },
                { name: "weapon", type: "Double", description: "调整玩家在发射子弹套装时发射子弹的NPC" },
                { name: "alive", type: "Double", description: "玩家是否存活" },
                { name: "climbing", type: "Byte", description: "玩家是否在攀爬" },
                { name: "forecolor", type: "Byte", description: "玩家的Sprite显示前景色" },
                ...
                { name: "inwater", type: "Double", description: "玩家是否在流体中" },
                ...
                { name: "section", type: "Byte", description: "玩家当前所在的场景ID" },
            ]
        },
        {
            name: "-effect-return-",
            field: [
                ...
                { name: "extx", type: "Integer", description: "Effect图像位于GFX扩展坐标系的X坐标" },
                { name: "exty", type: "Integer", description: "Effect图像位于GFX扩展坐标系的Y坐标" },
        ...
        },
        {
            ...
            field: [
                ...
                { name: "ivala", type: "Integer", description: "自定义变量A" },
                { name: "ivalb", type: "Integer", description: "自定义变量B" },
                { name: "ivalc", type: "Integer", description: "自定义变量C" },
                ...
                { name: "dtcliquid", type: "Byte", description: "NPC 是否可以和流体互动" },
